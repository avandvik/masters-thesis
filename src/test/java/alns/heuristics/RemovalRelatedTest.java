...
public class RemovalRelatedTest {
    ...
    private Solution createExpectedSolutionNoRandomness() {
        ...
        Set<Order> unplacedOrders = new HashSet<>(Arrays.asList(Problem.getOrder(4), Problem.getOrder(5),
                Problem.getOrder(3)));
    ...
    private Solution createExpectedSolutionRandomness() {
        ...
        Set<Order> unplacedOrders = new HashSet<>(Arrays.asList(Problem.getOrder(2), Problem.getOrder(4),
                Problem.getOrder(3)));
        return new Solution(orderSequences, postponedOrders, unplacedOrders);
    }
}
