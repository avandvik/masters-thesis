...
public class SolutionGenerator {
    ...
    public static Solution createSolutionBasicTestData(int sep1, int sep2, int sep3) {
        ...
        for (int i = sep2; i < sep3; i++) orderSequences.get(2).add(Problem.getOrder(i));
        for (int i = sep3; i < Problem.getNumberOfOrders(); i++) postponedOrders.add(Problem.getOrder(i));
